...
class KNearestNeighbor:
    ...
    def compute_distances_two_loops(self, X):
        ...
        - dists: A numpy array of shape (num_test, num_train) where dists[i, j]
          ...
          point.
        """
        num_test = X.shape[0] # количество строк в тестовых данных
        num_train = self.X_train.shape[0] # количество строк в тренировочных данных
        dists = np.zeros((num_test, num_train)) # результирующий размер матрицы с расстояниями.
        # num_test – строки
        # num_train – столбцы
